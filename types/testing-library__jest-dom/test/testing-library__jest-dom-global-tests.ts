...
expect(element).toHaveDescription(/some description/);
expect(element).toHaveDescription(expect.stringContaining('some description'));
...
expect(element).not.toHaveDescription(/some description/);
expect(element).not.toHaveDescription(expect.stringContaining('some description'));
